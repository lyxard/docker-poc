...
var headerDataLen = new Array("45px","80px","510px");
...
<form name="info">
    <table>
        <tr>
          <td>
              <a href="https://$ip/" ><img height="50" src="https://$ip/images/insideaccoImages/accoLogoClr.gif" border="0"></img></a>
          </td>
          <td>
...
<table>
 ...
 <tr>
  <td>
   ...
   <td>
     <input type="button" id="canRec" value="Cancel" OnClick="cancelRecord()" disabled"></input>
